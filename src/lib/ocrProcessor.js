...
//       // Process the image
//       const { data: { text, lines } } = await this.worker.recognize(imageUrl);
      
//       // Clean up the object URL
//       URL.revokeObjectURL(imageUrl);
      
//       // Return both raw text and processed lines
//       return {
//         rawText: text,
...
//   processLines(lines) {
//     return lines
//       .filter(line => line.text.trim().length > 0) // Remove empty lines
//       .map((line, index) => ({
//         id: index,
//         text: line.text.trim(),
